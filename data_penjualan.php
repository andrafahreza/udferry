                  ...
                  <div class="card-header">
                    ...
                    <div class="card-header-action">
						<form method="POST" action="print_penjualan.php" target="_blank">
							<a href="penjualan.php" class="btn btn-primary">Tambah</a>
						</form>
                    </div>
                  </div>
                  <div class="card-body">
                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
							  ...
							  <?php if (@$_SESSION['jabatan_user']==2){?>
							  <td rowspan="2">
                                <span data-target="#hapusPenjualan" data-toggle="modal" data-nota_penjualan="<?php echo $row['nota_penjualan']; ?>" data-tanggal="<?php echo $row['tanggal']; ?>">
                                  <a class="btn btn-danger btn-action mr-1" title="Hapus" data-toggle="tooltip"><i class="fas fa-trash"></i></a>
                                </span>
								<form method="POST" action="print_invoice.php" target="_blank">
									<div class="btn-group">
									<input type="hidden" class="form-control" name="nota_penjualan" required="" value="<?php echo $row['nota_penjualan']; ?>" readonly>
									  <button type="submit" class="btn btn-primary" name="printone" title="Invoice" data-toggle="tooltip"><i class="fas fa-print"></i></button>
									</div>
								</form>
							  </td>
							  <?php } ?>
