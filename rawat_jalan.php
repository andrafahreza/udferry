...
<head>
  ...
  $cek = mysqli_query($conn, "SELECT * FROM pasien WHERE nomor_rm='$nomor_rm' OR id='$nomor_rm'");
  ...
  if (isset($_POST['jalan1'])) {
    if ($cekrow == 0) {
      mysqli_query($conn, "INSERT INTO pasien (nomor_rm,nama_pasien, tinggi_badan, berat_badan) VALUES ('$nomor_rm','', '0', '0')");
  ...
  if (isset($_POST['jalan2'])) {
    ...
    mysqli_query($conn, "UPDATE pasien SET nama_pasien='$nama_pasien',alamat='$alam', tgl_lahir='$tgl', berat_badan='$berat', tinggi_badan='$tinggi' WHERE nomor_rm='$nomor_rmmu'");
  }
                      ...
                      <div class="wizard-pane">
                        <?php if (empty($_POST)) { ?>
                          ...
                          <div class="form-group row align-items-center">
                            <label class="col-md-4 text-md-right text-left">Nomor Rekam Medis</label>
                            <div class="col-lg-4 col-md-6">
                              <input id="myInput" type="number" class="form-control" name="nomor_rm" placeholder="Nomor Rekam Medis" required >
                        ...
                        if (isset($_POST['jalan1'])) { ?>
                          ...
                          <div class="form-group row align-items-center">
                            <label class="col-md-4 text-md-right text-left">Nomor Rekam Medis</label>
                            <div class="col-lg-4 col-md-6">
                              <input type="hidden" name="nomor_rm" class="form-control" required="" value="<?php echo $tokne['nomor_rm']; ?>">
                              <input type="text" class="form-control" required="" value="<?php echo $tokne['nomor_rm']; ?>" disabled>
                            </div>
                          </div>
                          <div class="form-group row align-items-center">
                            <label class="col-md-4 text-md-right text-left">Nama Lengkap</label>
                            <div class="col-lg-4 col-md-6">
                              <input type="text" class="form-control" required="" name="nama_pasien" value="<?php echo $tokne['nama_pasien']; ?>">
                            </div>
                          </div>
                          <div class="form-group row">
