...
<head>
  ...
  <title>Warehouse Penjualan - Login</title>
      ...
      if($cek == 0){
        ...
        setTimeout(function() {
          swal({
            ...
            $_SESSION['jabatan_user'] = $userid['jabatan'];
          }
        }
        ?>
      </head>
			  ...
			  <div class="row">			  
                <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">                  
				  <div class="card card-primary">
					...
					<br>
                    <center>
					<img src="../assets/img/logo.jpg" alt="logo" width="100" class="shadow-light">					
					</center>
                ...
                <div class="simple-footer">
                  Copyright &copy; Warehouse Penjualan dan Stok Barang 2024
                  <br><center><p>Repost by Geby Yolanda Sinaga </p></center>
